...
function (_React$Component) {
  ...
  function Newgooglemap(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentWillReceiveProps", function () {
      _this.props.meetingpointJson != undefined ? _this.setState({
        location: _this.props.meetingpointJson
      }) : null;
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onClickMap", function (e) {
      ...
      }); // this.props.getMeetingPoint(this.Latlngvalue.props.value)


      _this.props.getMeetingPoint(_this.state.location);
    });
  ...
  _createClass(Newgooglemap, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("div", {
        ...
        defaultCenter: this.state.location // this.props.meetingpointJson
        ,
...
//# sourceMappingURL=modifyproduct.js.bc6faf5cbe2c09980072.hot-update.js.map