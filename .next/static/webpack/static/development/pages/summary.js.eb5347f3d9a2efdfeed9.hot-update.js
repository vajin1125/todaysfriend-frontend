...
function (_React$Component) {
  ...
  function BookingSummaryForm(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "makeLanguageArray", function () {
      ...
      if (_this.state.booking_language.length != 0) {
        var lang = _this.state.booking_language.split(',');
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSubmit", function (e) {
      ...
      _this.props.form.validateFieldsAndScroll(function (err, values) {
        if (!err) {
          console.log('Received values of form: ', values); // const starttime = this.state.starttime
...
//# sourceMappingURL=summary.js.eb5347f3d9a2efdfeed9.hot-update.js.map