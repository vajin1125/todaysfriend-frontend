    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSubmit", function (e) {
      ...
      _this.props.form.validateFieldsAndScroll(function (err, values) {
        if (!err) {
          ...
          console.log('not days:', _this.state.textareaDays); // console.log('meetingtime:', this.state.meetingtime);
...
//# sourceMappingURL=createproduct.js.adf0b9e9eece04b12729.hot-update.js.map