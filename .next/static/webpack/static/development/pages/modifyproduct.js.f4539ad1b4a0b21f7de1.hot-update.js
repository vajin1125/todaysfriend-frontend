...
function (_React$Component) {
  ...
  function ModifyProductForm(props) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_21___default()({
        ...
        if (response.status === 200) {
          ...
          notDaysArray.forEach(function (day) {
            ...
            array.push(new Date(sp_day[0], sp_day[1], sp_day[2]));
            console.log("1111111111111111", array);
          });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSubmit", function (e) {
      ...
      _this.props.form.validateFieldsAndScroll(function (err, values) {
        if (!err) {
          ...
          var notAllowedDate = _this.notallowed.picker.state.value.format("YYYY-MM-DD");
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onFinish", function () {
      ...
      console.log("OnFinsh-notallowed:", _this.notallowed.picker.state.value.format("YYYY-MM-DD"));
      console.log("OnFinish-seasonfrom", _this.season.picker.state.value[0].format("YYYY-MM-DD"));
      console.log("OnFinish-seasonto", _this.season.picker.state.value[1].format("YYYY-MM-DD"));
    });
...
//# sourceMappingURL=modifyproduct.js.f4539ad1b4a0b21f7de1.hot-update.js.map