...
function (_React$Component) {
  ...
  function ModifyProductForm(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getMeetingPoint", function (point) {
      _this.state.meetingpointJson = point;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSubmit", function (e) {
      ...
      _this.props.form.validateFieldsAndScroll(function (err, values) {
        if (!err) {
          ...
          var meetingpoint = _this.state.meetingpointJson;
...
//# sourceMappingURL=modifyproduct.js.7b31ecdd2e6ad3849f24.hot-update.js.map