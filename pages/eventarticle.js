    ...
    onSubmit = (e) => {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                axios({
                    method: 'post',
                    url: base_url + '/api/save_event_article_comment',
                    data: {
                        values,
...
export default class extends React.Component {
    ...
    render() {
        const { area, name, content, loading, commentData, period } = this.state;
