    ...
    onSubmit = (e) => {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                axios({
                    method: 'post',
                    url: base_url + '/api/save_travel_article_comment',
                    data: {
                        values,
                            ...
                            <Row type="flex" justify="center">
                                <Col span={18}>
                                    ...
                                    <Link href="https://www.facebook.com/">
                                        <a><img src={facebookicon_1} style={{width:30,height:30,marginRight:20}} /></a>
                                    </Link>
                                    <Link href="https://www.instagram.com/">
                                        <a><img src={instagramicon} style={{width:30,height:30,marginRight:20}} /></a>
                                    </Link>
                                    <Link href="https://www.kakao.com/">
                                        <a><img src={kakaotalkicon} style={{width:30,height:30,marginRight:20}} /></a>
                                    </Link>
                                </Col>
                            </Row>
                        </div>
